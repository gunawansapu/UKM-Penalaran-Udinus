...
// EvenCard Component
const EvenCard = ({ title, date, description, category, time, location, className }) => {
  ...
  return (
    <div className={`bg-white rounded-2xl shadow-lg hover:shadow-xl p-6 border border-gray-100 ${className}`}>
      <div className="flex items-start justify-between mb-4">
        <div className={`px-3 py-1 rounded-full text-xs font-medium text-white bg-gradient-to-r ${getCategoryColor(category)}`}>
          {category}
        </div>
