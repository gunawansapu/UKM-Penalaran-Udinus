...
// import { activityList } from '../data/aktifitasDetail'; // Buka komen jika memang dipakai
...
const newsList = [
  ...
  { 
    ...
    description: 'Selamat kepada Amelia Calista dan tim karena telah mendapat Gold Medal dari International Science Project Competition (ISPC) 2025!', 
  ...
  { 
    id: 2, 
    title: 'Juara 2 Krenova Kategori Mahasiswa 2025', 
    date: '8 September 2025', 
    description: 'Kayla Assifa Rizqi Utami berhasil meraih Juara 2 Krenova 2025 melalui karya inovatif yang mencerminkan kreativitas.', 
  ...
  { 
    ...
    description: 'Anggota UKM Penalaran kembali mengukir prestasi melalui pendanaan riset LPDP.', 
  ...
  { 
    ...
    date: '18 Juli 2025', 
    description: 'Eksplorasi ide inovatif untuk penelitian bersama DinusLib.', 
  ...
  { 
    ...
    description: 'Selamat kepada senior UKM Penalaran Usamah Bienladen terpilih sebagai wisudawan terbaik.', 
